...
export const ForceReceivedButton = styled(ShipmentButton, {
  shouldForwardProp: (prop) => prop !== "forceReceived"
})<{ forceReceived?: boolean }>(({ forceReceived }) => ({
  borderTop: "1px solid #c3c3c3ff",
  fontWeight: 700,
  backgroundColor: "#fff",
  color: forceReceived ? "#4caf50" : "#398bd3",
  borderRight: "1px solid #ccc",
  "&.Mui-disabled": {
    color: forceReceived ? "#4caf50" : "#aaa",
    backgroundColor: "#CBCBCBFF", // ✅ fixed single #
    cursor: "not-allowed",       // optional: show disabled cursor
  },
  "&:hover": {
    backgroundColor: forceReceived ? "#e8f5e9" : "#dcecff", // optional: hover for non-disabled
  },
}));

export const ReceivedButton = styled(ShipmentButton)(() => ({
  borderTop: "1px solid #c3c3c3ff",
