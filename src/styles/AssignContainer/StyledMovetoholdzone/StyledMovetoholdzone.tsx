...
export const MoveToHoldZoneButton = styled(ShipmentButton, {
  shouldForwardProp: (prop) => prop !== "movetoholdzone"
})<{ movetoholdzone?: boolean }>(({ movetoholdzone }) => ({
  borderTop: "1px solid #c3c3c3ff",
  fontWeight: 700,
  backgroundColor: "#fff",
  color: movetoholdzone ? "#4caf50" : "#398bd3",
  borderRight: "1px solid #ccc",
  "&.Mui-disabled": {
    color: movetoholdzone ? "#4caf50" : "#aaa",
    backgroundColor: "#CBCBCBFF", // ✅ fixed single #
    cursor: "not-allowed",       // optional: show disabled cursor
  },
  "&:hover": {
    backgroundColor: movetoholdzone ? "#e8f5e9" : "#dcecff", // optional: hover for non-disabled
  },
}));

export const DismissButton = styled(ShipmentButton)(() => ({
  borderTop: "1px solid #c3c3c3ff",
  backgroundColor: "#ffffffff",
  color: "#398bd3ff",
  "&:hover": {
