                                            ...
                                            <StyledTooltip key={index} arrow title={side.IsNotAvailable(row)?.message}>
                                                <Box 
                                                    ...
                                                    sx={{ 
                                                        ...
                                                        height: '60px', 
                                                        backgroundColor: side.isSelected(row.LocationId) && side.currentMode !== BlockModes.SLOT_CONTROL ? props.colors.fullness : row.IsOccupied ? props.colors.block : row.IsAvailable ? 'transparent' : 'darkgrey', 
